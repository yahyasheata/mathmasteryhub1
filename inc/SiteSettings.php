...
if (!function_exists('mmh_site_settings_defaults')) {
    function mmh_site_settings_defaults(): array
    {
        return [
            ...
            'landing_stats_enabled' => '1',
            'landing_stats_title' => '',
            'landing_stats_description' => '',
            'landing_why_enabled' => '1',
            'landing_why_title' => 'A focused learning environment, not another noisy dashboard.',
            'landing_why_description' => 'Everything is organized around what students actually need each week: the lesson, the recording, the homework and the feedback.',
            'landing_paths_enabled' => '1',
            'landing_paths_title' => 'Browse by what you are studying.',
            'landing_paths_description' => 'Start with the path that matches your syllabus, level or current goal.',
            'landing_experience_enabled' => '1',
            'landing_experience_title' => 'One place for lessons, practice and parent-friendly progress.',
            'landing_experience_description' => 'The platform supports the live course instead of replacing it. Students can review, submit and continue without hunting for links.',
            'landing_testimonials_enabled' => '1',
            'landing_testimonials_title' => 'Designed to make the next step obvious.',
            'landing_testimonials_description' => '',
            'landing_faq_enabled' => '1',
            'landing_faq_title' => 'Simple answers before you begin.',
            'landing_faq_description' => '',
            'landing_cta_enabled' => '1',
            'landing_cta_title' => 'Start with a clear learning path.',
            'landing_cta_description' => 'Browse the course spaces and choose the one that matches your current mathematics goal.',
            'landing_cta_primary_label' => 'Browse Courses',
            'landing_cta_primary_url' => '/courses',
...
if (!function_exists('mmh_site_settings_allowed_keys')) {
    function mmh_site_settings_allowed_keys(): array
    {
        return [
            ...
            'landing_stats_enabled' => ['type' => 'toggle', 'category' => 'Homepage'],
            'landing_stats_title' => ['type' => 'text', 'max' => 160, 'category' => 'Homepage'],
            'landing_stats_description' => ['type' => 'textarea', 'max' => 500, 'category' => 'Homepage'],
            'landing_why_enabled' => ['type' => 'toggle', 'category' => 'Homepage'],
            'landing_why_title' => ['type' => 'text', 'max' => 190, 'category' => 'Homepage'],
            'landing_why_description' => ['type' => 'textarea', 'max' => 700, 'category' => 'Homepage'],
            'landing_paths_enabled' => ['type' => 'toggle', 'category' => 'Homepage'],
            'landing_paths_title' => ['type' => 'text', 'max' => 190, 'category' => 'Homepage'],
            'landing_paths_description' => ['type' => 'textarea', 'max' => 700, 'category' => 'Homepage'],
            'landing_experience_enabled' => ['type' => 'toggle', 'category' => 'Homepage'],
            'landing_experience_title' => ['type' => 'text', 'max' => 190, 'category' => 'Homepage'],
            'landing_experience_description' => ['type' => 'textarea', 'max' => 700, 'category' => 'Homepage'],
            'landing_testimonials_enabled' => ['type' => 'toggle', 'category' => 'Homepage'],
            'landing_testimonials_title' => ['type' => 'text', 'max' => 190, 'category' => 'Homepage'],
            'landing_testimonials_description' => ['type' => 'textarea', 'max' => 700, 'category' => 'Homepage'],
            'landing_faq_enabled' => ['type' => 'toggle', 'category' => 'Homepage'],
            'landing_faq_title' => ['type' => 'text', 'max' => 190, 'category' => 'Homepage'],
            'landing_faq_description' => ['type' => 'textarea', 'max' => 700, 'category' => 'Homepage'],
            'landing_cta_enabled' => ['type' => 'toggle', 'category' => 'Homepage'],
            'landing_cta_title' => ['type' => 'text', 'max' => 190, 'category' => 'Homepage'],
            'landing_cta_description' => ['type' => 'textarea', 'max' => 700, 'category' => 'Homepage'],
            'landing_cta_primary_label' => ['type' => 'text', 'max' => 80, 'category' => 'Homepage'],
            'landing_cta_primary_url' => ['type' => 'internal_or_url', 'max' => 500, 'category' => 'Homepage'],
            'landing_cta_secondary_label' => ['type' => 'text', 'max' => 80, 'category' => 'Homepage'],
            'landing_cta_secondary_url' => ['type' => 'internal_or_url', 'max' => 500, 'category' => 'Homepage'],
