...
foreach (['mmh_revision_update_batch_controls', 'mmh_revision_prepare_editable_version', 'visibility', "'open_all'", 'This Batch has student progress and cannot be hidden', 'source_batch_id', 'Batch does not belong to the selected Version'] as $marker) if (!str_contains($service, $marker)) throw new RuntimeException('Batch control service contract is missing: ' . $marker);
