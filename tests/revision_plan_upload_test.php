...
foreach (['Your answer', 'Replace answer PDF', 'revision_files[]', 'Add one or more PDF files.', 'Choose PDF files', 'Submitted files', 'revision-batch-navigation', 'revision-batch-materials-top', 'revision-material-row', 'Open PDF', 'Batch resources', 'revision-batch-strip', 'Coming soon'] as $marker) if (!str_contains($student, $marker)) throw new RuntimeException('Revision student upload/batch UI is missing: ' . $marker);
