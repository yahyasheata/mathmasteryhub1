...
foreach (['Upload answer PDF', 'Replace answer PDF', 'revision_files[]', 'Batch materials', 'revision-batch-strip', 'Coming soon'] as $marker) if (!str_contains($student, $marker)) throw new RuntimeException('Revision student upload/batch UI is missing: ' . $marker);
