...
foreach (['Upload answer PDF', 'Replace answer PDF', 'revision_files[]', 'Upload PDF files', 'Choose PDF files', 'Submitted files', 'revision-batch-navigation', 'revision-batch-materials-top', 'revision-material-row', 'Open PDF', 'Batch materials', 'revision-batch-strip', 'Coming soon'] as $marker) if (!str_contains($student, $marker)) throw new RuntimeException('Revision student upload/batch UI is missing: ' . $marker);
