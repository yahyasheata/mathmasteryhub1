...
if (!str_contains((string) $courseContent, 'course-manager.css?v=assignment-card-compact-20260809')) throw new RuntimeException('Assignment card stylesheet cache-bust is missing.');
