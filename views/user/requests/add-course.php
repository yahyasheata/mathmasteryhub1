    ...
    && !empty($_POST['course_title']) && !empty($_POST['course_title_en']) && !empty($_POST['course_price']) && !empty($_POST['course_description']) ) {
        ...
        if(isset($_FILES['course_image']) && !$_FILES['course_image']['error'] ){
            ...
            if($uploadImgResponse->status === 1){
                ...
                $query = "INSERT INTO courses (course_id,course_title,course_title_en,course_description,course_image,course_price,course_category,username) VALUES('$course_id','$course_title','$course_title_en','$course_description','$course_image','$course_price','$course_category','$username')";
