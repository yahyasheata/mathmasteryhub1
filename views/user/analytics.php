...
<head>
    ...
    <style>
      .student-recovery-plan{margin:0 0 12px;padding:16px;border:1px solid color-mix(in srgb,var(--primary) 30%,var(--border));border-radius:var(--radius-md);background:color-mix(in srgb,var(--primary) 6%,var(--surface))}.student-recovery-plan-head,.student-recovery-plan-task{display:flex;align-items:center;justify-content:space-between;gap:12px}.student-recovery-plan-head strong{color:var(--primary);font-size:1rem}.student-recovery-plan-head span{color:var(--text-muted);font-size:.8rem}.student-recovery-plan-task{padding-top:10px;margin-top:10px;border-top:1px solid color-mix(in srgb,var(--primary) 20%,var(--border))}.student-recovery-plan-task div{min-width:0}.student-recovery-plan-task strong{display:block;overflow-wrap:anywhere;color:var(--text-primary);font-size:.86rem}.student-recovery-plan-task small{display:block;margin-top:3px;color:var(--text-muted);font-size:.75rem}.student-recovery-plan-list{display:grid;gap:5px;margin:11px 0 0;padding:9px 0 0;border-top:1px solid color-mix(in srgb,var(--primary) 20%,var(--border));list-style:none}.student-recovery-plan-list li{display:grid;grid-template-columns:20px minmax(0,1fr) auto;gap:6px;align-items:center;color:var(--text-secondary);font-size:.77rem}.student-recovery-plan-list li>span:first-child{color:var(--success);font-weight:800}.student-recovery-plan-list small{color:var(--text-muted);font-size:.7rem}.student-recovery-plan-complete{display:flex;align-items:center;gap:9px;color:var(--success);font-weight:800}.student-recovery-plan-complete small{display:block;color:var(--text-muted);font-size:.75rem;font-weight:500}@media(max-width:560px){.student-recovery-plan-task{display:block}.student-recovery-plan-task .student-progress-button{width:100%;margin-top:9px}.student-recovery-plan-complete{align-items:flex-start;flex-wrap:wrap}.student-recovery-plan-complete .student-progress-button{width:100%}}
    </style>
</head>
