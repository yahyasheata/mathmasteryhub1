...
<main class="p-0 font-2">
    ...
    <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
      <div class="col-lg-5 position-relative order-lg-2 px-0">
        ...
        <div class="overlap-grid overlap-grid-2">
          <div class="item">
            <figure class="rounded shadow"><img src="resources/images/screenshots/2.png"  alt=""></figure>
          </div>
          <div class="item">
  ...
  <!-- /.container -->
</section><section class="wrapper image-wrapper bg-auto no-overlay bg-image text-center bg-map" data-image-src="resources/.assets/img/map.png">
