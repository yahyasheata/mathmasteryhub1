...
<head>
    ...
    <link rel="stylesheet" href="<?=$baseUrl?>/resources/css/course-manager.css?v=assignment-card-compact-20260809-r4-course-copy-20260821-r2">
...
(function($) {
  ...
  function populateTypeFilter() {
    ...
    var label = { recording: 'Recording', notes: 'Notes', classified_assignment: 'Assignment', timed_exam: 'Timed Exam', assignment_model_answer: 'Assignment Model Answer', custom_lesson: 'Custom Lesson', custom_html: 'Legacy Lesson', resource: 'Structured Resource', legacy: 'Legacy Lesson', video: 'Video', file: 'File', quiz: 'Quiz' };
