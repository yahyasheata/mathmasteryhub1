                            ...
                            <fieldset class='form-fieldset api-mode'>
                                    ...
                                    <div class='col-12 col-lg-6 p-2'>
                                            ...
                                            <div class='col-12 pt-3'>
                                                <input type='text' name='category_title' required='' maxlength='190' class='form-control'  placeholder='اكتب عنوان Category' value='$category_title' >
                                            </div>
                                        </div>
                                        ...
                                        <div class='col-12 col-lg-6 p-2'>
                                            ...
                                            <div class='col-12 pt-3'>
                                                <textarea class='form-control' name='category_description' rows='3' placeholder='اكتب وصف Category هنا - SEO' required>$category_description</textarea>
                                            </div>
                                        </div>
...
if($_SERVER['REQUEST_METHOD'] == "POST" ){
  if(isset($_POST['_method']) && $_POST['_method'] == 'UPDATE' ){
    ...
    if ( isset($_POST['category_title'],$_POST['category_link'],$_POST['category_description']) && !empty($_POST['category_title']) && !empty($_POST['category_link']) ) {
        ...
        $old_category_image = mysqli_fetch_assoc(mysqli_query(db(),"SELECT category_image FROM categories WHERE category_id='$category_id' "))['category_image'];
