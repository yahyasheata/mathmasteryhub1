...
$syllabuses = mmh_past_syllabuses($conn, '', true);
...
<main class="classroom-scanner-page">
    ...
    <section class="classroom-scanner-card">
        ...
        <div class="classroom-scanner-toolbar">
            ...
            <div><label class="form-label" for="classroom-syllabus">Target syllabus</label><select id="classroom-syllabus" class="form-control classroom-scanner-select" name="syllabus_id" form="classroom-scan-form" required><option value="">Choose Cambridge Mathematics 0580</option><?php foreach ($syllabuses as $syllabus): ?><option value="<?= $escape($syllabus['syllabus_id']) ?>" <?= $selectedSyllabus === $syllabus['syllabus_id'] ? 'selected' : '' ?>><?= $escape($syllabus['public_title'] . ' · ' . $syllabus['syllabus_code']) ?></option><?php endforeach; ?></select></div>
